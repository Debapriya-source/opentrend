...
class AnalysisService:
    ...
    def _generate_trend_description(
        ...
        if trend_type == "bullish":
            ...
            description += f"Price is above key moving averages and MACD is positive. "
            ...
            description += f"Price is below key moving averages and MACD is negative. "
            ...
            description += f"Technical indicators are mixed, suggesting indecision in the market."
    ...
    def _predict_volatility(self, df: pd.DataFrame, horizon_days: int) -> Dict[str, Any]:
        ...
        return {
            ...
            "features_used": {"current_vol": current_volatility, "long_term_vol": long_term_volatility},
        }
