...
class Settings(BaseSettings):
    ...
    influxdb_bucket: str = Field(default="market_data", description="InfluxDB bucket")
    ...
    sentiment_model_name: str = Field(default="cardiffnlp/twitter-roberta-base-sentiment-latest", 
